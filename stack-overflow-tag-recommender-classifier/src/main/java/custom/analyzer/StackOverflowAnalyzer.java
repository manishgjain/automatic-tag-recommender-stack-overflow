...
public class StackOverflowAnalyzer extends Analyzer {
	...
	final List<String> stopWords = Arrays.asList("a","about","above","after","again",
			...
			"yours","yourself","yourselves","a's","able","about","above","according",
			...
			"however","i'd","i'll","i'm","i've","ie","if","ignored","immediate","in","inasmuch",
			...
			"nearly","necessary","need","needs","neither","never","nevertheless","new","next",
			"nine","no","nobody","non","none","noone","nor","normally","not","nothing","novel",
			...
			"th","than","thank","thanks","thanx","that","that's","thats","the","their","theirs",
			...
			"with","within","without","won't","wonder","would","wouldn't","yes","yet","you","you'd","you'll",
			"you're","you've","your","yours","yourself","yourselves","zero","a","able","about","above","abst",
			...
			"already","also","although","always","am","among","amongst","an","and","announce","another","any",
			...
			"below","beside","besides","between","beyond","both","brief","briefly","but","by","c","ca","came",
			"can","cannot","can't","cause","causes","certain","certainly","co","com","come","comes","contain",
			"containing","contains","could","couldnt","d","date","did","didn't","different","do","does","doesn't",
			"doing","done","don't","down","downwards","due","during","e","each","ed","edu","effect","eg","eight",
			"eighty","either","else","elsewhere","end","ending","enough","especially","et","et-al","etc","even",
			"ever","every","everybody","everyone","everything","everywhere","ex","except","f","far","few","ff",
			"fifth","first","five","fix","followed","following","follows","for","former","formerly","forth",
			"found","four","from","further","furthermore","g","gave","get","gets","getting","give","given",
			"gives","giving","go","goes","gone","got","gotten","h","had","happens","hardly","has","hasn't",
			"have","haven't","having","he","hed","hence","her","here","hereafter","hereby","herein","heres",
			"hereupon","hers","herself","hes","hi","hid","him","himself","his","hither","home","how","howbeit",
			"however","hundred","i","id","ie","if","i'll","im","immediate","immediately","importance","important",
			"in","inc","indeed","index","information","instead","into","invention","inward","is","isn't","it",
			"itd","it'll","its","itself","i've","just","k","keep","keeps","kept","kg","km","know","known",
			"knows","l","largely","last","lately","later","latter","latterly","least","less","lest","let","lets",
			"like","liked","likely","line","little","'ll","look","looking","looks","ltd","m","made","mainly",
			"make","makes","many","may","maybe","me","mean","means","meantime","meanwhile","merely","mg",
			"might","million","miss","ml","more","moreover","most","mostly","mr","mrs","much","mug","must",
			"my","myself","n","na","name","namely","nay","nd","near","nearly","necessarily","necessary",
			...
			"sufficiently","suggest","sup","sure","what","where","how","when","why","which","were",
			"find","myself","these","know","anybody","somebody","differences","good","best","much",
			"less","more","most","been","reading","your","mine","with","doing","interested","also",
			"from","that","like","there","would","answer","question","need","about","have","this",
			"using","another","difference","between","across","want","able","although","always");

	@Override
	protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
		LetterTokenizer tokenizer = new LetterTokenizer(Version.LUCENE_46, reader);
		
		TokenStream tok = new LowerCaseFilter(Version.LUCENE_46, tokenizer);
		tok = new StandardFilter(Version.LUCENE_46, tok);
		tok = new LengthFilter(Version.LUCENE_46, tok, 3, 100);
		
		final CharArraySet stopSet = new CharArraySet(Version.LUCENE_46, stopWords.size(), true);
		stopSet.addAll(stopWords);
		stopSet.add(StopAnalyzer.ENGLISH_STOP_WORDS_SET);
		tok = new StopFilter(Version.LUCENE_46, tok, stopSet);
